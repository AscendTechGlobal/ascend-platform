...
export default function SystemsVisual() {
  return (
    <section className="relative py-32 sm:py-48 overflow-hidden bg-[#0B0F14]">
      ...
      {/* 1. Background Image using standard HTML img to guarantee visibility */}
      <img
        src="/images/dashboard.png"
        alt="Dashboard"
        className="absolute inset-0 w-full h-full object-cover object-right md:object-center opacity-40 z-0"
      />

      {/* 2. Gradient Overlay to ensure text readability */}
      <div className="absolute inset-0 bg-gradient-to-r from-[#0B0F14] w-full lg:w-2/3 z-10" />
...
print("SystemsVisual overridden with pure img tag.")
